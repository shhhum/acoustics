# room-acoustics — sound-room acoustical simulator
...
Everything lives under `room-acoustics/`; the earlier single-file instrument `soundsystem-designer.jsx` stays at the repo root untouched.
...
data/presets/       saved input configurations (whole scenes)
data/walls/         named wall stacks (save/load from the Wall and Room pages)
